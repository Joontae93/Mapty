...
new (class App {
  ...
  #getTheCoordinates = async function () {
    ...
    this.places.forEach(place => {
      ...
      const promise = getData('http://api.positionstack.com/v1/forward', params)
        .then(({ data }) => {
  ...
  #setMapView() {
    const checks = [this.selectedBusiness, ...this.selectedBusiness.coords];
    console.log(checks);
    ...
    if (isUndefined) {
      ...
      } else map.flyTo(this.selectedBusiness.coords, 13, { duration: 1.5 });
    }
  }
